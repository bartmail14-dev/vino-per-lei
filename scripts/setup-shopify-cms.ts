...
async function seedContent() {
  ...
  await createMetaobject('announcement_bar', 'main', [
    { key: 'message', value: 'Authentieke Italiaanse wijnen, zorgvuldig geselecteerd' },
  ...
  const usps = [
    ...
    { handle: 'veilig-betalen', title: 'Veilig betalen', subtitle: 'Via Shopify Checkout', icon_name: 'shield', sort_order: '4' },
  ];
  ...
  const faqItems = [
    ...
    { handle: 'betalen-1', category: 'Betalen', question: 'Welke betaalmethodes accepteren jullie?', answer: 'De actuele betaalmethodes zie je tijdens het afrekenen in de beveiligde Shopify Checkout. Wij tonen alleen betaalmethodes die daar actief zijn en slaan zelf geen betaalgegevens op.', sort_order: '4' },

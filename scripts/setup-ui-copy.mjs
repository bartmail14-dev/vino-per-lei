...
const entries = [
  ...
  ["product.curated_by", "", "product", "Optionele curatiebadge producthero. Leeg laten om deze regel te verbergen."],
  ...
  ["home.org.description", "Italiaanse wijnen van Vino per Lei, rechtstreeks van zorgvuldig gekozen producenten.", "home", "Structured data omschrijving homepage"],
  ...
  ["home.featured.subtitle", "", "home", "Optionele subtitel uitgelichte producten. Leeg laten om deze regel te verbergen."],

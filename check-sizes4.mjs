...
await wait(2000);
await page.screenshot({ path: '../screenshot-grid-v4.png', fullPage: false });

// Also scroll to see more cards
await page.evaluate(() => window.scrollBy(0, 400));
await wait(500);
await page.screenshot({ path: '../screenshot-grid-v4-scroll.png', fullPage: false });

// Product page
await page.goto('https://vino-per-lei.vercel.app/wijnen/montaribaldi-barolo-2019', { waitUntil: 'networkidle0', timeout: 60000 });
await wait(2000);
await page.screenshot({ path: '../screenshot-product-v4.png', fullPage: false });

// Mobile
await page.setViewport({ width: 393, height: 852, deviceScaleFactor: 3, isMobile: true });
await page.goto('https://vino-per-lei.vercel.app/wijnen', { waitUntil: 'networkidle0', timeout: 60000 });
await wait(2000);
await page.screenshot({ path: '../screenshot-mobile-v4.png', fullPage: false });

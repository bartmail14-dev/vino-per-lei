// Centralized shared icons for Vino per Lei
// Each icon accepts { className?: string } props
// HeartIcon also accepts optional { filled?: boolean }
// CheckIcon uses strokeWidth="2" by default
...
export function ThumbUpIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      <path d="M14 9V5a3 3 0 00-6 0v4H5a2 2 0 00-2 2v7a2 2 0 002 2h12.28a2 2 0 002-1.7l1.38-9A2 2 0 0018.72 7H14z" />
    </svg>
  );
}
...
export function SunIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      ...
      <path d="M12 1V3M12 21V23M4.22 4.22L5.64 5.64M18.36 18.36L19.78 19.78M1 12H3M21 12H23M4.22 19.78L5.64 18.36M18.36 5.64L19.78 4.22" strokeLinecap="round" />
    </svg>
  );
}

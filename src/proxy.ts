...
function applySecurityHeaders(request: NextRequest, response: NextResponse): NextResponse {
  ...
  response.headers.set(
    ...
    [
      ...
      "img-src 'self' data: https://cdn.shopify.com https://images.unsplash.com https://vino-per-lei.vercel.app https://*.vinoperlei.nl https://*.google-analytics.com https://www.googletagmanager.com",
      "font-src 'self'",
      "connect-src 'self' https://*.myshopify.com https://*.google-analytics.com https://*.analytics.google.com https://www.googletagmanager.com",
      "media-src 'self'",
      "manifest-src 'self'",
